...
- **LocalO** — Terminal-based social media platform inspired by Facebook — posts, friends, pages, and a messenger system, built as an OOP course project
...
- **Human Response and the Impact of Using AI Tools: Evidence from University Students in Dhaka, Bangladesh** — co-authored with Md Monirul Islam, Md Anuwer Hossain, and Md. Rayhan Ahamed — a study examining how university students in Dhaka respond to and are affected by the growing use of AI tools in academic settings — *Currently under review*
