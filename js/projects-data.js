// Add new projects here — each entry automatically appears on projects.html
// category options currently used: "Team", "Individual", "Hardware", "Systems Analysis"
const PROJECTS = [
  {
    title: "RunGirlRun",
    category: "Team",
  ...
  },
  {
    ...
    description:
      "An endless running game with coin collection. Colliding with an obstacle triggers a mini-game — solving it grants an extra life.",
    link: ""
  },
  {
  ...
  {
    title: "Mayer Doa Emergency Service",
    category: "Systems Analysis",
    role: "",
    tags: ["DFDs", "Use Cases", "Prototyping", "Systems Analysis"],
    description:
      "A systems analysis project for an online + SMS-based emergency healthcare coordination platform for Dhaka Medical College Hospital — DFDs, use case diagrams, prototype mockups, and process specifications. Analysis only, no implementation. Team: SAD Express.",
    link: ""
  }
];
